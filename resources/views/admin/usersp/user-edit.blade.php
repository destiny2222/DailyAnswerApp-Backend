                    ...
                    <form action="{{ route('admin.customer-update', $user->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" value="{{ $user->name }}" name="name" class="form-control @error('name') is-invalid @enderror" id="basic-default-fullname" placeholder="Full name" />
                                @error('name')
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" value="{{ $user->phone }}" name="phone" class="form-control @error('phone') is-invalid @enderror" id="basic-default-fullname" placeholder="Phone Number" />
                                @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="file" value="{{ $user->profile_picture }}" name="profile_picture" class="form-control @error('profile_picture') is-invalid @enderror" id="profile_picture" accept="image/*" />
